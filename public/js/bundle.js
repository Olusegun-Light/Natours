...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoibGlnaHQtc2VucGFpIiwiYSI6ImNsbHVzd3VvZzE3anEzZ256YmJ1ZnB5Y24ifQ.d_OQRh8pIII1JFEcGPEpQg";
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (res.data.status === "success") {
            ...
            (0, _alerts.showAlert)("error", "Failed to update data");
          }
          _context.next = 11;
          break;
        case 8:
...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
// Public stripe key
var stripe = Stripe("pk_test_51NoyDIGn2Y7gh3TNDtWIKx7G6kOgaIGAgC6q9QhQR9fliO7Dl7ZkVXAx7rzbjhyueMYZtJsHGfWrV1Jn9BGFXV5a00rmj0By7E");
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          ...
          "error", (0, _alerts.showAlert)(_context.t0);
        case 12:
        case "end":
          return _context.stop();
      }
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "13737" + '/');
